...
const items = [
    ...
    },
    {
      ...
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/TrialKafka.jpg?20210513174412',  
    ...
    },
    {
      ...
      imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Samuelbeckettsgodot.jpg/144px-Samuelbeckettsgodot.jpg',  
    ...
    },
    {
      ...
      imageUrl: 'https://upload.wikimedia.org/wikipedia/en/a/a3/NoExit_cover.gif',
      description: 'No Exit is a one-act play by Jean-Paul Sartre that explores existentialism and the nature of hell. Three characters find themselves trapped in a room for eternity, gradually realizing that their punishment is the psychological torture they inflict upon each other—leading to the famous line, "Hell is other people."'
    }
